...
div.TitleButtonTableWrap{height:23px;overflow:visible;position:relative;z-index:8;width:100%;zoom:1;}
...
ul.TitleButtonTable{font-family:arial;font-size:17px;list-style:none outside none;position:absolute;right:0;top:0;white-space:nowrap;z-index:55;zoom:1;padding:0;margin:0;}
ul.TitleButtonTable li{display:inline-block;*display:inline;zoom:1;padding:1px 2px;position:relative;z-index:10;vertical-align:middle;height:23px;zoom:1;}
...
.autocomplete{border-right:#b6c5f2 thin outset;border-top:#b6c5f2 thin outset;border-left:#b6c5f2 thin outset;border-bottom:#b6c5f2 thin outset;background-color:#ffffff;clear:left;z-index:10;visibility:hidden;font-family:monospace;position:absolute;top:1px;left:1px;font-size:9pt;zoom:1;}
...
#pageOuterWrap.popup #link_help{display:block;width:21px;float:none;}
...
#helpWrap.openText a#link_help{color:#1B63AA!important;padding-left:25px;}
#pageOuterWrap.popup #helpWrap.openText {width: 75px;}
div.menuList,
...
#entityLabel{float:left;color:#0B86E0;font-family:"Times New Roman", Georgia;font-size:19px;background-color:#FFFFFF;}
...
a.favNewWindow{padding:0 !important;background:url("/webspeed/icons_sprite.png") no-repeat scroll 0 -82px transparent;height:17px;width:20px;position:absolute;z-index:0;right:3px;top:3px;text-decoration:none!important;color:transparent!important;zoom:1;}
...
div.systemItem {position:relative;padding-right:25px;}
...
div.setupMenu{background-color:#F2F6FA;border:1px solid #6F91B0;display:none;line-height:20.8px;padding:7px;position:absolute;right:-1px;text-align:left;top:25px;_top:24px;width:auto;min-width:100px;z-index:79;zoom:1;}
...
div.setupMenu a:hover{text-decoration:underline;background:none!important;}
...
div.navSectionWrap{border-top:1px solid #BABABA;box-shadow:0 0 6px #BABABA;-moz-box-shadow:0 0 6px #BABABA;-webkit-box-shadow:0 0 6px #BABABA;border-color:#BBBBBB #DBDBDB #DBDBDB;border-style:solid;border-width:1px;border-bottom-width:0;position:relative;z-index:1;zoom:1;}
...
.button, .buttonDisabled{display:block;margin:3px 2px;padding:2px 3px;text-align:center;text-decoration:none;width:61px;font-size:11px;font-family:arial;color:#286EB3;border-width:1px;border-style:solid;outline:medium none !important;}
a.buttonDisabled,
...
#browseViewArea,#filterAreaWrap {float:left;}
...
.calPicker{background-image:url("/webspeed/icons_sprite.png");background-position:0 -443px;background-repeat:no-repeat;display:inline-block;*display:inline;zoom:1;width:21px;height:14px;line-height:14px;*line-height:18px;text-decoration:none!important;padding:2px 0;margin:0;}
...
#fsMessageWrap {color: #FF0000;cursor: pointer;font-family: monospace;font-size: 13px;font-weight: bold;left: -15px;position: absolute;text-align: right;text-decoration: underline;top: 5px;white-space: nowrap;width: 0;overflow: visible;text-indent: -100%}
...
a.cke_toolbox_collapser {position:relative;}
div.toolbar_message {display:none;position:absolute;top:-2px;right:14px;color:#545454;cursor:pointer;}
a.cke_toolbox_collapser_min div.toolbar_message {display:block;}
